...
@Component({
  selector: 'aa-alerts-mrr-grid',
  templateUrl: './alerts-mrr-grid.component.html',
  styleUrls: ['./alerts-mrr-grid.component.less']
})
export class AlertsMrrGridComponent implements OnInit, OnDestroy {
