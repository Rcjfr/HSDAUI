...
import { ModifiedPartDescriptionComponent } from './modified-part-description.component';
...
describe('SearchByCorrectiveActionComponent', () => {
  let component: ModifiedPartDescriptionComponent;
  let fixture: ComponentFixture<ModifiedPartDescriptionComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ModifiedPartDescriptionComponent);
