...
//
  ...
  { key: 'RepairDate', display: 'Repair Date' , dbField: 'REPAIR_DATE'},
  ...
  { key: 'RemovedByDate', display: 'Repair Removed Date' , dbField: 'REMOVED_BY_DATE'},
  ...
  { key: 'DteRepairStatus', display: 'Status(DTE)' , dbField: 'DTE_REPAIR_STATUS_DESC'},
  ...
  { key: 'DteCompType', display: 'Component Type' , dbField: 'DTE_COMP_TYPE_DESC'},
  { key: 'ControlOrderNumber', display: 'Control Order #' , dbField: 'CONTROL_ORDER_NUMBER'},
  { key: 'CompAaid', display: 'AAID' , dbField: 'COMP_AAID'},
  { key: 'CompSerialNum', display: 'Component S/N' , dbField: 'COMP_SERIAL_NUM'},
  { key: 'CompRspam', display: 'RSPAM' , dbField: 'COMP_RSPAM'},
  { key: 'CompMpn', display: 'MPN' , dbField: 'COMP_MPN'},
  { key: 'CompHours', display: 'Hours(DTE Component)' , dbField: 'COMP_HOURS'},
  { key: 'CompCycles', display: 'Cycles(DTE Component) ' , dbField: 'COMP_CYCLES'},
...
///
  ...
  { key: 'DTEInspectionThreshold3', display: 'Inspection Threshold(3)', dbField: 'DTE_INSPECTION_THRESHOLD3' },
  { key: 'DTEInspectionThreshold4', display: 'Inspection Threshold(4)', dbField: 'DTE_INSPECTION_THRESHOLD4' },
  { key: 'DTEInspectionThreshold5', display: 'Inspection Threshold(5)', dbField: 'DTE_INSPECTION_THRESHOLD5' },
