...
@Component({
  selector: 'aa-alerts-save-searches',
  templateUrl: './alerts-save-searches.component.html',
  styleUrls: ['./alerts-save-searches.component.less']
})
export class AlertsSaveSearchesComponent implements OnInit {
