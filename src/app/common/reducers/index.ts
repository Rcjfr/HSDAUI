...
export const getRepairDescriptionTypes = compose(fromLookupData.getRepairDescriptionTypes, getLookupDataState);
export const getRepairDocumentTypes = compose(fromLookupData.getRepairDocumentTypes, getLookupDataState);
