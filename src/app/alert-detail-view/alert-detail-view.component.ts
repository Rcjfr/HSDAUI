...
ngAfterContentInit(): void { // ngAfterViewInit(): void {
  ...
  var frm = this.elRef.nativeElement.querySelector('form');
  this.formInputElements = Array.prototype.slice.call(frm.querySelectorAll('input,select'));
 // console.log(this.formInputElements);
        // Watch for the blur event from any input element on the form.
     console.log(this.formInputElements.length);
     // console.log(this.sdaHtmlForm);
